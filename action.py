...
# 파일 경로
a_file_path = '/Users/hun/GoodGangLabs Dropbox/Individuals/Jeonghun/rnd/PoC/blender_drive/json/drivers_04.json'  # 예시 경로, 실제 경로로 변경 필요
b_file_path = '/Users/hun/GoodGangLabs Dropbox/Individuals/Jeonghun/rnd/PoC/blender_drive/json/poc_shapekey_01_shape_keys.json'  # 예시 경로, 실제 경로로 변경 필요
